        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
                    ...
                    <ul class="dropdown-menu">
                        <li class="external">
                            <h3>@lang('mposuccess::profile.topmenu.messages.new')<span class="bold">7</span></h3>
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        ...
                        <li>
                            <a href="page_calendar.html">
                                <i class="icon-calendar"></i> @lang('mposuccess::profile.topmenu.mycalendar') </a>
                        </li>
                        <li>
                            <a href="inbox.html">
                                <i class="icon-envelope-open"></i>
                                @lang('mposuccess::profile.topmenu.myinbox')
