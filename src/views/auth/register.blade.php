        ...
        <div class="form-group">
            ...
            <div class="controls">
                <div class="input-icon">
                    ...
                    <input class="form-control form-control-inline date-picker" name="birthday" placeholder="Дата рождения" size="16" type="text" value="{{ old('birthday') }}">
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="controls">
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Пригласивший"
                           name="refferal" value="{{ old('referral') }}"/>
                </div>
            </div>
        </div>
        <div class="form-group">
